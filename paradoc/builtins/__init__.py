...
def initialize_builtins(env: Environment, sandboxed: bool, debug: bool) -> None:
    ...
    cput('/j', [], [Case.value_n2v(lambda e: e * -1j)], stability="alpha", docs="Divide by the imaginary unit; equivanetly, multiply by -1j. Deeply vectorizes.")
    ...
    cput('Pure_imaginary', ['&j'], [Case.value_n2v(lambda e: int(e.real == 0))], stability="unstable", docs="Test if the real part is zero. Deeply vectorizes.")
